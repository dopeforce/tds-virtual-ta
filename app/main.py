...
<body>
  <div class="glass-container">
    ...
    <script>
      ...
      function updateEndpoint() {
        ...
        commandElement.textContent = commandElement.textContent.replace(
          /curl -X POST .*? https:\/\/[^ ]+/,
          `curl -X POST -H "Content-Type: application/json" -d '{"question":"Should I use gpt-4o-mini which AI proxy supports, or gpt3.5 turbo?","image":"'"$(curl -s \"https://tds.s-anand.net/images/project-tds-virtual-ta-q1.webp\" | base64 -w0)"'"}}' ${newEndpoint}`
        );
      ...
      async function testEndpoint() {
        ...
        try {
          ...
          responseStatus.className = `ml-2 px-2 py-1 rounded ${response.ok ? "bg-green-600 text-white" : "bg-red-600 text-white"}`;
        ...
        <div class="accordion-content bg-gray-900">
          ...
          <div class="code-block-wrapper">
            <button class="copy-button" onclick="copyCode('dynamicCommand')" title="Copy to clipboard">
              <svg xmlns="http://www.w3.org/2000/svg" xml:space="preserve" width="16" height="16" viewBox="0 0 96 96">
                <path
    ...
    "image": "'"$(curl -s "https://tds.s-anand.net/images/project-tds-virtual-ta-q1.webp" | base64 -w0)"'"
          ...
          <div class="mt-4">
            <button id="testButton" onclick="testEndpoint()"
            ...
            <div id="testResult" class="mt-3 hidden">
              <div class="flex items-center text-sm font-medium">
                ...
                <span id="responseStatus" class="ml-2 px-2 py-1 rounded"></span>
              </div>
              <pre id="responseData" class="mt-2 bg-gray-800 p-3 rounded text-xs overflow-auto max-h-40"></pre>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="accordion-item">
        ...
        <div class="accordion-content bg-gray-900">
          <div class="code-block-wrapper">
            <button class="copy-button" onclick="copyCode('linuxCommand')" title="Copy to clipboard">
              <svg xmlns="http://www.w3.org/2000/svg" xml:space="preserve" width="16" height="16" viewBox="0 0 96 96">
                <path
                  d="M72 12h-4.697C65.652 7.342 61.223 4 56 4H40c-5.223 0-9.652 3.342-11.303 8H24c-6.63 0-12 5.37-12 12v56c0 6.63 5.37 12 12 12h48c6.63 0 12-5.37 12-12V24c0-6.63-5.37-12-12-12zm-32 0h16a4 4 0 0 1 0 8H40a4 4 0 0 1 0-8zm36 68c0 2.21-1.79 4-4 4H24c-2.21 0-4-1.79-4-4V24c0-2.21 1.79-4 4-4h4.697c1.648 4.658 6.08 8 11.303 8h16c5.223 0 9.652-3.342 11.303-8H72c2.21 0 4 1.79 4 4v56z">
                </path>
            ...
            <pre id="linuxCommand"><code>curl -X POST -H "Content-Type: application/json" -d "$(jq -n \
    ...
    '{question: $question, image: $image}')" <span class="dynamic-endpoint">https://virtual-ta.pythonicvarun.me/api</span></code></pre>
          </div>
...
sudo dnf install jq    # Fedora</code></pre>
      ...
      <div class="accordion-item">
        ...
        <div class="accordion-content bg-gray-900">
          <div class="code-block-wrapper">
            <button class="copy-button" onclick="copyCode('macosCommand')" title="Copy to clipboard">
              <svg xmlns="http://www.w3.org/2000/svg" xml:space="preserve" width="16" height="16" viewBox="0 0 96 96">
                <path
                  d="M72 12h-4.697C65.652 7.342 61.223 4 56 4H40c-5.223 0-9.652 3.342-11.303 8H24c-6.63 0-12 5.37-12 12v56c0 6.63 5.37 12 12 12h48c6.63 0 12-5.37 12-12V24c0-6.63-5.37-12-12-12zm-32 0h16a4 4 0 0 1 0 8H40a4 4 0 0 1 0-8zm36 68c0 2.21-1.79 4-4 4H24c-2.21 0-4-1.79-4-4V24c0-2.21 1.79-4 4-4h4.697c1.648 4.658 6.08 8 11.303 8h16c5.223 0 9.652-3.342 11.303-8H72c2.21 0 4 1.79 4 4v56z">
                </path>
            ...
            <pre id="macosCommand"><code>curl -X POST -H "Content-Type: application/json" -d "$(jq -n \
    --arg question 'Should I use gpt-4o-mini which AI proxy supports, or gpt3.5 turbo?' \
    ...
    '{question: $question, image: $image}')" <span class="dynamic-endpoint">https://virtual-ta.pythonicvarun.me/api</span></code></pre>
          ...
          <div class="mt-2 text-sm text-gray-400">
            ...
            <pre class="bg-gray-800 p-2 rounded mt-1"><code>curl -s "https://tds.s-anand.net/images/project-tds-virtual-ta-q1.webp" | base64 | tr -d '\n'</code></pre>
          </div>
        </div>
      </div>
      ...
      <div class="accordion-item">
        ...
        <div class="accordion-content bg-gray-900">
          <div class="code-block-wrapper">
            <button class="copy-button" onclick="copyCode('windowsCommand')" title="Copy to clipboard">
              <svg xmlns="http://www.w3.org/2000/svg" xml:space="preserve" width="16" height="16" viewBox="0 0 96 96">
                <path
                  d="M72 12h-4.697C65.652 7.342 61.223 4 56 4H40c-5.223 0-9.652 3.342-11.303 8H24c-6.63 0-12 5.37-12 12v56c0 6.63 5.37 12 12 12h48c6.63 0 12-5.37 12-12V24c0-6.63-5.37-12-12-12zm-32 0h16a4 4 0 0 1 0 8H40a4 4 0 0 1 0-8zm36 68c0 2.21-1.79 4-4 4H24c-2.21 0-4-1.79-4-4V24c0-2.21 1.79-4 4-4h4.697c1.648 4.658 6.08 8 11.303 8h16c5.223 0 9.652-3.342 11.303-8H72c2.21 0 4 1.79 4 4v56z">
                </path>
            ...
            <pre id="windowsCommand"><code>$imageBase64 = [Convert]::ToBase64String((Invoke-WebRequest -Uri "https://tds.s-anand.net/images/project-tds-virtual-ta-q1.webp" -UseBasicParsing).Content)
$body = @{
    question = "Should I use gpt-4o-mini which AI proxy supports, or gpt3.5 turbo?"
    image = $imageBase64
} | ConvertTo-Json -Compress

curl.exe -X POST -H "Content-Type: application/json" -d $body <span class="dynamic-endpoint">https://virtual-ta.pythonicvarun.me/api</span></code></pre>
          </div>
        </div>
      </div>
    </div>
    ...
    <footer class="mt-6 text-sm text-slate-400">
      Explore the
      <a href="/docs" class="text-sky-400 hover:underline">API documentation</a>
